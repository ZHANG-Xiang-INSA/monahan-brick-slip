...
(function () {
  ...
  window.I18N = {
    ...
    model_sub:     { zh: "7,544 砖片 + 2,177 卡扣 · 逐片建模，可交互查看", en: "7,544 slips + 2,177 clips · modelled piece by piece, fully interactive" },
    ...
    cut_bricks_sub:{ zh: "%d 种砖型 · 1:1 真实轮廓", en: "%d brick types · true 1:1 outlines" },
    cut_clips_sub: { zh: "%d 型 · M 形成型钢 · 展开料 118 · 含 40° 斜切", en: "%d types · formed M-section · 118 blank · incl. 40° mitres" },
    ...
    mat_lede:      { zh: "每块 47mm 砖坯切除 3mm 锯缝，得到两片 22mm 砖片 — 做砖数 = 等效整砖 ÷ 2。", en: "Each 47 mm brick is sliced (3 mm kerf) into two 22 mm slips — bricks to make = equivalent-whole ÷ 2." },
